...
public class Constant {
	...
	public static final String BASE_URL = "https://10.123.194.22:8743";

	//please replace the appId and secret, when you use the demo.
	//test
	public static final String APPID = "eHEGIwxRtkTquUKpQHEQw10Pv5Qa";
	public static final String SECRET = "MBCz1QzHOiirIauzZ8pGy0oGdO0a";
	//test 2018-11-20 11:36:53
//	public static final String APPID = "zOfrnnJLUYqcrEdvaU7EChYK5HYa";
//	public static final String SECRET = "5RmjVFuZCN1HWwJEnhG7nB8ymXYa";

	//商用app
//    public static final String APPID = "nTBGZIJSV_fwUSFnBtpLnaB4bWYa";
//    public static final String SECRET = "qDhDgpaYdIELI30Ly3zC9hJwY1sa";
	//bonc
//	public static final String APPID = "ADmT6ct4corizNQy4bTNdfSIJGka";
//	public static final String SECRET = "dnWgpqTF_M2fg2ZAXhu24jHe7E8a";
	/*
	 ...
	 */
	public static final String CALLBACK_BASE_URL = "https://59.219.104.138:9001";
//	public static final String CALLBACK_BASE_URL = "https://192.168.0.100:9001";
	/*
	...
	public static final String DEVICE_DATA_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/analysis/dataChange";
...
//	public static String SELFCERTPATH = "cert/demo/outgoing.CertwithKey.pkcs12";
//	public static String TRUSTCAPATH = "cert/demo/ca.jks";

	public static String SELFCERTPATH = "cert/bak/outgoing.CertwithKey.pkcs12";
	public static String TRUSTCAPATH = "cert/bak/ca.jks";

	//Password of certificates.
	// public static String SELFCERTPWD = "bonc123456";
	public static String SELFCERTPWD = "IoM@1234";
	public static String TRUSTCAPWD = "Huawei@123";
	// public static String TRUSTCAPWD = "bonc123456";
	 ...
	 */
	public static final String SUBSCRIBE_SERVICE_NOTIFYCATION = BASE_URL + "/iocm/app/sub/v1.2.0/subscriptions?ownerFlag=true";
