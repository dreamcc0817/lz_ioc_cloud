...
public class Constant {
    ...
    public static final String BASE_URL = "https://100.115.187.142:8743";

    //please replace the appId and secret, when you use the demo.
    public static final String APPID = "V5GoPVogmI42UEfd0QgCQMgIMAQa";
    public static final String SECRET = "hNPAYng8sLawkWzuOhBjDlR9VZMa";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://10.61.37.175:9999";
