package com.bonc.ioc.core.page;

import com.bonc.ioc.core.util.ReflectHelper;
...
public class PagePlugin implements Interceptor {
	...
	private static String pageSqlId = "selectByPage"; //mapper.xml中需要拦截的ID(正则匹配)
...
//						logger.error(new McpException(e).getCode() + "\r\n" + countSql + "\r\n访问参数：" + JSON.toJSONString(map));
						throw e;
					}
					int count = 0;
					if (rs.next()) {
...
//			logger.error(new DAOException(e).getCode() + "\r\n" + sql + "\r\n访问参数：" + JSON.toJSONString(map));
